...
public class Zodiacs {
        ...
        private static final String[] signs = {"Aries", "Taurus", "Gemini", "Cancer","Leo","Virgo","Libra","Scorpio","Sagittarius","Capricorn","Capricorn","Aquarius","Pisces"};
        private static final String[][] dates = {{"21.03", "20.04"}, {"21.04", "21.05"},{"22.05", "21.06"},
