...
public class ShopQueue {
    ...
    public static void main(String[] args) {
        Product water=new Product("Воды",2.10);
        Product bread=new Product("Хлеб",2.40);
        Product reece=new Product("Рис",2.60);
...
class Customer implements Comparable{
    ...
    public int compareTo(Object o) {
        ...
        int index2=((Customer)o).type.ordinal();//приведение типа
