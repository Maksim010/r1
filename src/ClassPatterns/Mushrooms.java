...
public class Mushrooms {
    public static void main(String[] args) {
        ...
        System.out.println(micelium.getMashroom(MushroomType.Russula,1,1).toDetailString());
        System.out.println(micelium.getMashroom(MushroomType.Russula,2,2).toDetailString());
...
class Micelium{
    ...
    public Mushroom getMashroom(MushroomType mushroomType,int x,int y) {
        Mushroom mushroom = mushroomMap.get(mushroomType);
        if (mushroom == null) {
            new Mushroom(mushroomType);
